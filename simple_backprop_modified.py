"""
in simple_backprop.py file, numpy broadcasting was used, and sometimes it's not intuitive to understand
thus, in this modified implementation, all weights matrix and calculations are down explicitly 
"""
